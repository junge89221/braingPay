...
public class MutilRadioGroup extends LinearLayout {
    // holds the checked categoryId; the selection is empty by default
    ...
    public CharSequence getAccessibilityClassName() {
        return MutilRadioGroup.class.getName();
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(MutilRadioGroup group, @IdRes int checkedId);
    }
